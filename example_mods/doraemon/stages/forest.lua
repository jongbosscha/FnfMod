...
function onUpdatePost()
	setProperty("trees.angle", -getProperty("camFollowPos.x") / 220)
	setProperty("brush_2.angle", -getProperty("camFollowPos.x") / 240)
	setProperty("brush_1.angle", -getProperty("camFollowPos.x") / 260)
end