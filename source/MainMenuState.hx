...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		char1 = new Character(700, -130, 'me before', true);
		char1.setGraphicSize(Std.int(char1.width * 0.8));
		add(char1);
		char1.visible = false;

		char2 = new Character(730, -80, 'GF_dad', false);
		char2.setGraphicSize(Std.int(char2.width * 0.6));
		add(char2);
		char2.visible = false;

		char3 = new Character(620, 30, 'dragon', true);
		char3.setGraphicSize(Std.int(char3.width * 0.9));
		add(char3);
		char3.visible = false;

		char4 = new Character(675, 130, 'dragon son playable', true);
		char4.setGraphicSize(Std.int(char4.width * 0.8));
		add(char4);
		char4.visible = false;

		char5 = new Character(700, 320, 'sciruns kids', false);
		char5.setGraphicSize(Std.int(char5.width * 0.7));
		add(char5);
		char5.visible = false;

		char6 = new Character(710, 500, 'vanz', true);
		char6.setGraphicSize(Std.int(char6.width * 0.8));
		add(char6);
		char6.visible = false;

		char7 = new Character(750, 640, 'me', true);
		char7.setGraphicSize(Std.int(char7.width * 4.2));
		add(char7);
		char7.visible = false;
